...
<header>
    <!-- Logo on the left -->
    <div class="logo">
        <img src="image/Logo diorama.png" alt="Diorama Logo"> <!-- Add your logo image here -->
    </div>

    <!-- Navigation in the center -->
    <nav>
        <ul>
            <li><a href="SingInAs.php">Home</a></li>
            <li><a href="SingInAs.php">Shop All</a></li>
            <li><a href="SingInAs.php">About Us</a></li>
        </ul>
    </nav>

    <!-- Shopping Bag on the right -->
    <div class="icons">
        <a href="SingInAs.php"><i class="fas fa-shopping-bag"></i></a> <!-- Shopping Bag Icon -->
		<span id="cart-counter" style="color: white; font-size: 1.2em; margin-left: 5px;">0</span><!-- Added a cart counter-->
		<a href="SingInAs.php"><i class="fas fa-user"></i></a> <!-- User Account Icon -->
    </div>
</header>
...
<div class="hero">
    ...
    <a href="SingInAs.php">Shop Now</a>
</div>
      ...
      <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item active">
            <img class="d-block w-100" src="image/alice dollhouse.png" alt="Bestseller Book Nook">
            <div class="carousel-caption text-center">
              ...
              <a href="SingInAs.php" class="btn btn-primary">View Details</a>
            </div>
          </div>
