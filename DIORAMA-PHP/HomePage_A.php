...
<header>
    <!-- Logo on the left -->
    <div class="logo">
        <a href="HomePage_A.php"><img src="image/Logo diorama.png" alt="Diorama Logo"></a> <!-- Wrap the logo with a link -->
    </div>
    ...
    <div class="icons">
		...
		<a href="SignIn_A.php"><i class="fas fa-user"></i></a> <!-- User Account Icon -->
    </div>
</header>
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-caption text-center">
              ...
              <a href="shop_A.php" class="btn btn-primary">View Details</a>
            </div>
          </div>
